        ...
        <div class="col-xl-12 box-margin height-card">
            <div class="card card-body">
                <div class="d-md-flex justify-content-between align-items-center mb-20">
                    <h4 class="card-title">{{ __('content.edit_blog') }}
                        <!-- Button -->
                    ...
                    <div class="row">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input id="title" name="meta_description" type="text" class="form-control" value="{{ $blog->meta_description }}">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                            ...
                                                                            <div class="media">
                                                                                @if (!empty($blog->custom_breadcrumb_image))
                                                                                    <a  class="d-block mx-auto" href="#" data-toggle="tooltip" data-placement="top" data-original-title="{{ __('content.current_image') }}">
                                                                                        <img src="{{ asset('uploads/img/blog/breadcrumb/'.$blog->custom_breadcrumb_image) }}" alt="image" class="rounded">
                                                                                    </a>
                                                                                @else
                        ...
                        <div class="col-md-4">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="section_image_2">{{ __('content.image') }} ({{ __('content.size') }} 800 x 600) (.svg, .jpg, .jpeg, .png, .webp)</label>
