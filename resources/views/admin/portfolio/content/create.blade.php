                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select name="breadcrumb_status" class="form-control" id="breadcrumb_status">
                                                                            ...
                                                                            <option value="yes" {{ $portfolio_content->breadcrumb_status == 'yes' ? 'selected' : '' }}>{{ __('content.yes') }}</option>
                                                                            <option value="no" {{ $portfolio_content->breadcrumb_status == 'no' ? 'selected' : '' }}>{{ __('content.no') }}</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-12">
                                                                                    ...
                                                                                    <div class="media">
                                                                                        @if (!empty($portfolio_content->custom_breadcrumb_image))
                                                                                            <a  class="d-block mx-auto" href="#" data-toggle="tooltip" data-placement="top" data-original-title="{{ __('content.current_image') }}">
                                                                                                <img src="{{ asset('uploads/img/portfolio/breadcrumb/'.$portfolio_content->custom_breadcrumb_image) }}" alt="image" class="rounded">
                                                                                            </a>
                                                                                        @else
