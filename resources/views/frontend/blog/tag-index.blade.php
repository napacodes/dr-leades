...
<head>
    ...
    <meta name="title" content="@if (!empty($tag_name)) {{ $tag_name }} @elseif (!empty($page_builder->meta_title)) {{ $page_builder->meta_title }} @elseif (isset($seo)){{ $seo->meta_title }} @endif">
    ...
    <meta property="og:title" content="@if (!empty($tag_name)) {{ $tag_name }} @elseif (!empty($page_builder->meta_title)) {{ $page_builder->meta_title }} @elseif (isset($seo)){{ $seo->meta_title }} @endif">
    ...
    <meta property="twitter:title" content="@if (!empty($tag_name)) {{ $tag_name }} @elseif (!empty($page_builder->meta_title)) {{ $page_builder->meta_title }} @elseif (isset($seo)){{ $seo->meta_title }} @endif">
    ...
    <!-- Title -->
    <title>@if (!empty($tag_name)) {{ $tag_name }} @elseif (!empty($page_builder->meta_title)) {{ $page_builder->meta_title }} @elseif  (isset($seo)) {{ $seo->meta_title }} @endif</title>
...
<div class="page-wrapper" id="wrapper">
    ...
    <main class="main-area">
        ...
        @include('frontend.blog.tag-index-list')
