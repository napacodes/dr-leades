...
<head>
    ...
    <meta name="description" content="@if (!empty($portfolio->meta_description)) {{ $portfolio->meta_description }} @elseif (!empty($page_builder->meta_description)) {{ $page_builder->meta_description }} @elseif (isset($seo)){{ $seo->meta_description }} @endif">
    <meta name="keywords" content="@if (!empty($portfolio->meta_keyword)) {{ $portfolio->meta_keyword }} @elseif (!empty($page_builder->meta_keyword)) {{ $page_builder->meta_keyword }} @elseif (isset($seo)){{ $seo->meta_keyword }} @endif">
    ...
    <meta property="og:description" content="@if (!empty($portfolio->meta_description)) {{ $portfolio->meta_description }} @elseif (!empty($page_builder->meta_description)) {{ $page_builder->meta_description }} @elseif (isset($seo)){{ $seo->meta_description }} @endif">
    ...
    <meta property="twitter:description" content="@if (!empty($portfolio->meta_description)) {{ $portfolio->meta_description }} @elseif (!empty($page_builder->meta_description)) {{ $page_builder->meta_description }} @elseif (isset($seo)){{ $seo->meta_description }} @endif">
