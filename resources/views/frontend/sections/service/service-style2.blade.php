                            ...
                            <div class="col-md-12">
                                @if (is_countable($service_count_categories) && count($service_count_categories) > 0)
                                    <div class="text-center mb-5 custom-category-link">
                                        <a href="{{ url($page_builder->page_uri) }}" class="current mb-2">{{ __('frontend.all_services') }}</a>
                                                ...
                                                @else
                                                    <div class="btn-box">
                                                        @if (!empty($service_detail_show->page_uri))
                                                            <a href="{{ url($service_detail_show->page_uri.'/'.$item->service_slug) }}">{{ __('frontend.read_more') }}  <i class="fa fa-arrow-right"></i></a>
                                                        @else
                                                            <a class="custom-max-width-80" href="{{ route('default-service-detail-show', ['service_slug' => $item->service_slug]) }}">{{ __('frontend.read_more') }}  <i class="fa fa-arrow-right"></i></a>
                                                        @endif
                                                    </div>
                                                @endif
                                            </div>
