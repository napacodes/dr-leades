                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="section-heading-left">
                                        <span>@php echo html_entity_decode($career_section_style1->section_title); @endphp</span>
                                        <h2>@php echo html_entity_decode($career_section_style1->title); @endphp</h2>
                                    </div>
                                </div>
                            </div>
                        @else
                            ...
                            <div class="row">
                                @isset ($career_section_style1)
                                    <div class="col-md-12 text-center">
                                        <a href="{{ $career_section_style1->button_url }}" class="primary-btn">
                                            <span class="text">{{ $career_section_style1->button_name }}</span>
