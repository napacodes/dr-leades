                            ...
                            @isset ($banner_style2)
                                <div class="col-lg-7 col-xl-6 col-md-10 wow fadeInUp">
                                    <div class="hero-inner">
                                        ...
                                        <h2>@php echo html_entity_decode($banner_style2->description); @endphp</h2>
                                        @if (!empty($banner_style2->button_name))
                                            <a href="{{ $banner_style2->button_url }}" class="white-btn me-md-3 mb-3">
                                                <span class="text">{{ $banner_style2->button_name }}</span>
                                                <span class="icon"><i class="fa fa-arrow-right"></i></span>
                                            </a>
                                        @endif
                                        @if (!empty($banner_style2->button_name_2))
                                            <a href="{{ $banner_style2->button_url_2 }}" class="white-btn">
                                                <span class="text">{{ $banner_style2->button_name_2 }}</span>
                                                <span class="icon"><i class="fa fa-arrow-right"></i></span>
                                            </a>
                                        @endif
                                    </div>
                                        ...
                                        <div class="hero-img">
                                            <div class="border-line-outer">
                                                <div class="border-line-inner">
                                                    <img src="{{ asset('uploads/img/banner/'.$banner_style2->section_image) }}" title="banner image" alt="banner image" class="img-fluid">
                                                </div>
                                            </div>
                                        </div>
                                    @endif
