...
class PageController extends Controller
{
    ...
    public function show($page_slug = null)
    {
        ...
        $page_builder = PageBuilder::where('language_id', $language->id)->where('page_name', 'page-detail-show')->first();
        ...
        return view('frontend.page.show', compact('preloader', 'favicon', 'seo', 'google_analytic',
            ...
            'socials', 'external_url', 'contact_info_widget_style1', 'menus', 'page',
            'header_info_style1', 'header_image_style1', 'footer_image_style1', 'site_info',
