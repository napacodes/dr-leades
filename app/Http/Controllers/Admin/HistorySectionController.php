...
class HistorySectionController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        // Update model
        HistorySection::find($id)->update($input);
    ...
    {
        // Retrieve a model
        $item_section = HistorySection::find($id);
        ...
        return redirect()->route('history.create', $item_section->style);
