...
class ContactInfoController extends Controller
{
    ...
    public function create($style = 'style1')
    {
        ...
        $items = ContactInfo::where('language_id', $language->id)->where('style', $style)->orderBy('id', 'desc')->get();
        $item_section = ContactInfoSection::where('language_id', $language->id)->where('style', $style)->first();

        return view('admin.sections.contact_info.create', compact('favicon','panel_image', 'items', 'item_section', 'style'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('contact-info.create', $input['style']);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('contact-info.create', $item->style);
    }
